...
export type InvestmentItemFrequency =
  (typeof InvestmentItemFrequency)[keyof typeof InvestmentItemFrequency];

export const InvestmentItemFrequency = {
  monthly: "monthly",
  yearly: "yearly",
} as const;
...
export const ScenarioSettingsCompoundingFrequency = {
  annual: "annual",
  monthly: "monthly",
  quarterly: "quarterly",
} as const;
